...
MenuDetailResult menuDetailResultFromJson(String str) =>
    MenuDetailResult.fromJson(json.decode(str));

String menuDetailResultToJson(MenuDetailResult data) =>
...
class MenuDetailResult {
  ...
  factory MenuDetailResult.fromJson(Map<String, dynamic> json) =>
      MenuDetailResult(
